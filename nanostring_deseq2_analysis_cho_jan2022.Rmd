...
These are the p-values of the relationship between the housekeeping genes and the treatment groups.  There appears to be no correlation between the housekeeping miRNAs and the obese/lean status.  
