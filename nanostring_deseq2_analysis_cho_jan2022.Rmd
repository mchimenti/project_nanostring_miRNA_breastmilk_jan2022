...
Controlled for BMI, contrast on collection time.  LRT model for time-dependent miRNAs. 
...
p <- p + ggtitle(" Counts by Status and Milk Col. Date Quartile")
p
...
```{r}
milk_df <- data.frame(col_date = pData$milk_col_dt, col_factor = ntile(pData$milk_col_dt, 4))
milk_df
```
